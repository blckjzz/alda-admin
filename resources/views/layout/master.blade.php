...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/admin/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.css')}}">
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-mini"><b>Alda</b></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>Alda</b></span>
        </a>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    <p>{{Auth::user()->name}}</p>
                    <!-- Status -->
                    <a href="#"><i class="fa fa-circle text-success"></i> {{ Auth::user()->conselho->ccs }}</a>
                </div>
            </div>
...
<script src="{{asset("/admin/plugins/jQueryUI/jquery-ui.js")}}"></script>
<script src="{{asset("/admin/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.js")}}"></script>
<!-- Bootstrap 3.3.7 -->
